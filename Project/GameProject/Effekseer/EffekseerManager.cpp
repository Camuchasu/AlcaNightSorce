	...
	ObjectBase(eEffectManager)
{
	...
	efk_data[] = {
		...
		{ "PlayerBullet",u"Effect/tktk01/PlayerBullet.efk" },
		{ "PSF",u"Effect/tktk01/PlayerSwordFire.efk" },
		{ "AreaChange",u"Effect/tktk01/Tp.efk" },
		{ "Frenzy",u"Effect/tktk01/PowerUp.efk" },
		{ "Change",u"Effect/tktk01/Change.efk" },
		{ "Sword",u"Effect/tktk01/Attack.efk" },
		{ "SetSword",u"Effect/tktk01/SetSword.efk" },
		{ "RubbleBreak",u"Effect/tktk01/RubbleBreak.efk" },
		{ "BossDeath",u"Effect/tktk01/BossDeath.efk" },
	};
...
{
	auto itr = m_effect_list.find(name);

	if (itr == m_effect_list.end())
	{
		return nullptr;
	}
