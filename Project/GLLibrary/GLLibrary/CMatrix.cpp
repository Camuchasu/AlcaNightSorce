...
//CMatrixクラスのRotation関数の実装
void CMatrix::Rotation(const CVector3D& r) {
...
//CMatrixクラスのMRotationX関数の実装
CMatrix CMatrix::MRotationX(float r) {
	CMatrix m;
	m.RotationX(r);
	return m;
}
//CMatrixクラスのMRotationY関数の実装
