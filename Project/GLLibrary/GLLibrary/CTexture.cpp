...
//CTextureクラスのUnmapTexture関数の実装
void CTexture::UnmapTexture() {
	if (m_bufID == 0) return;
	glBindTexture(GL_TEXTURE_2D, 0);
	glDisable(GL_TEXTURE_2D);
}
//CTextureクラスのDraw関数の実装
